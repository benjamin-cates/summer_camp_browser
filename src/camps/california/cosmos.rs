...
fn make_specializations(tracks: &[&'static str]) -> Vec<(&'static str, SummerCamp)> {
    assert_eq!(tracks.len() % 3, 0, "{}", tracks[0]);
    tracks
        .chunks(3)
        .map(|v| {
            (
                ...
                SummerCamp {
                    description: vec![v[1]],
                    requirements: vec![Requirement::Custom(v[2])],
                    ..Default::default()
                },
            )
        })
...
pub(crate) fn get_cosmos() -> impl Iterator<Item = SummerCamp> {
    let cosmos_default = SummerCamp {
        ...
        requirements: vec![
            ...
            Requirement::LetterOfRec("STEM teacher prefered"),
            Requirement::LetterOfRec("STEM teacher prefered, optional"),
            Requirement::Custom(
                "Select a first choice and a second choice cluster from ONE campus only",
            ),
            Requirement::RequiredEssay(
                "Explain why you chose your first choice",
                Limit::Words(0..=200),
            ),
            Requirement::RequiredEssay(
                "Explain why you chose your second choice",
                Limit::Words(0..=200),
            ),
            Requirement::RequiredEssay(
                "For each cluster you select with a prerequisite, please list courses taken that \
                 you feel meet the prerequisites for this cluster.",
                Limit::Words(0..=200),
            ),
            Requirement::MinUnweightedGPA(3.5),
            Requirement::UnofficialTranscript,
            Requirement::ActivityList(
                "Optional two activities. List activity name, description in 50 words, hours per \
                 week, weeks per year, and the years participated.",
            ),
            Requirement::RequiredEssay(
                "Beyond what has already been shared in your application, what do you believe \
                 makes you stand out as a strong candidate for admissions to COSMOS? If there’s \
                 anything you want us to know about you, but didn’t find a question or place in \
                 the application to tell us, now’s your chance. What have you not shared with us \
                 that will highlight a skill, talent, challenge or opportunity that you think \
    ...
    let cosmos_uci = SummerCamp {
        ...
        specialization: Some(make_specializations(&[
            ...
            "Prerequisites: High School Biology, Algebra II or Integrated Math II, and computer \
             literacy; interest in using computational tools and software to study and analyze \
            ...
            "Prerequisites: One year of high school Biology, Algebra II or Integrated Math II, \
             and Computer Literacy are required for student success. Preferred candidates have \
             taken some form of computer programming.",
    ...
    let cosmos_ucsd = SummerCamp {
        ...
        specialization: Some(make_specializations(&[
            ...
            "Prerequisites: Algebra II or Integrated Math II (To qualify for this cluster \
             students need to have very little or no prior programming experience and limited \
             opportunities to learn programming)",
            ...
            "Prerequisite: Algebra I and 8th-grade general science or equivalent. Recommended: \
             Open to students finishing their freshman or sophomore year prior to the summer",
            ...
            "Cluster 4 - Structural Engineering: Building Better (not 2025)",
            ...
            "Prerequisite: Two years of Algebra or Integrated Math I & II (with Trigonometry \
             component)",
            ...
            "Prerequisite: 1 year of Physics preferred",
            ...
            "Prerequisite: Introductory high school chemistry – Basic knowledge of ionic and \
             covalent bonding, electronegativity and intermolecular forces of attraction.",
            ...
            "Prerequisite: Open to students finishing their junior year prior to the summer. \
             Desirable skills (nice to have but not required): Biology, robotics (e.g., FIRST, \
             VEX, others) basic computer programming experience (Python and/or C/C++), hands-on \
             engineering class, and/or physics. Most importantly, “don’t be afraid of showing \
             that you don’t know something”, being willing to learn and not being afraid of \
             making mistakes is key. Please mention these skills and your attitude on learning in \
             your application. Swim waiver required if admitted to this Cluster.",
            "Cluster 8 - Tissue Engineering and Regenerative Medicine*",
            "*First choice only. Tissue Engineering (TE) and Regenerative Medicine (RM) both seek \
             to harness the power of biology and chemistry with the precision of engineering to \
             restore, maintain, or improve tissue functions. TE seeks to do so through the \
             application of engineering and life sciences to develop biological substitutes, \
             whereas RM targets therapies to induce regeneration of cells, tissues, and organs. \
             TE-RM are exciting and interdisciplinary fields involving engineers, biologists, \
             chemists, material scientists, and doctors. TE-RM are increasingly providing \
             alternative treatments for medical conditions where traditional treatments such as \
             drugs, medical devices, or transplants have limitations. TE-RM products are rapidly \
             evolving from potent molecules and materials to induce regeneration, to isolated \
             cells to reconstitute damaged tissue, culture-expanded cells to repair damaged \
             knees, modified cells to combat cancer, and formed tissues for drug screening, for \
             engineered skin to treat wounds and burns, and for replacement tissues and organs.",
            "Prerequisite: Students must have completed Algebra II or Integrated Math II and one \
             year of high school biology (Honors/AP Bio preferred if available)",
            ...
            "Prerequisite: An interest in the science of sound and the creation of sound art and \
             music through both software and hardware tools.",
            ...
            "Prerequisite: Algebra II or Integrated Math II, Programming experience is expected, \
            ...
            "Prerequisite: Open to students finishing their junior year prior to the summer. \
             Desirable skills (nice to have but not required): Biology, robotics (e.g., FIRST, \
             VEX, others) basic computer programming experience (Python and/or C/C++), hands-on \
             engineering class, embedded systems (microcontrollers such as Arduino), and/or \
             physics. Most importantly, “don’t be afraid of showing that you don’t know \
             something”, like working in teams, being willing to learn and not being afraid of \
             sharing / making mistakes is key. Please mention these skills and your attitude on \
             learning in your application.",
            ...
            "Have you ever wondered how Alexa or Siri learned to converse with us, or how \
             ...
             climate study.",
            "Prerequisite: Algebra II or Integrated Math II. This cluster is for students who \
             have limited prior programming experience (i.e., have taken no programming classes \
             or at most a single one; experience with Python is not required).",
            "Cluster 13 - Video Game Programming and Game AI Design (NOT 2025)",
            ...
            "Prerequisite: Algebra II or Integrated Math II. AP CS Principles or equivalent \
             computer programming experience.  Students should be comfortable with conditionals \
             (if/else), loops (for/while), and arrays/lists.",
        ])),
        ..cosmos_default.clone()
    };
    let cosmos_ucdavis = SummerCamp {
        ...
        specialization: Some(make_specializations(&[
            ...
            "Is it a particle? Is it a wave? It's both!  Electrons, normally considered \
             ...
             cluster. Typical Field Trips: Molecular Foundry and Advanced Light Source at \
             Lawrence Berkeley National Laboratory (LBNL);  Exploratorium in San Francisco. Core \
             courses: Computations of Quantum Phenomena and Quantum Physics Experiments and \
             Applications to Nanotechnology",
            "Prerequisites: Precalculus and Physics, or Equivalent; One year of laboratory \
             science, one year of physics strongly recommended",
            ...
            "Mechanical Engineering (2 Weeks) Modern Manufacturing Practice focuses on 3D \
             ...
             Experiments). Student Activities: Lab Experiments: Smoke Tunnel for Low-Speed \
             Aerodynamics, Water Table for High-Speed Aerodynamics, Convergent/Divergent Nozzle \
             Flows, Oscilloscopes, and Electrical Circuits. Classroom Demonstrations:  Dynamics \
             and Vibration, Solis Mechanics, Fluid Mechanics and Heat Transfer Projects. \
             Educational Toys: Remote Control Airplanes, Remote Control Drones, Remote Control \
             Boats, Toy Rockets.",
            ...
            "This cluster consists of four interrelated core courses that will be taught \
             ...
             be taught as part of the curriculum. Typical Field Trips: Rotary Community \
             Observatory, Lick Observatory, Exploratorium",
            ...
            "We know that everything, living or non-living, is made out of molecules. Molecules \
             ...
             behavior of biological molecules inside a living cell. Typical Field Trips: \
             Exploratorium, Schilling Robotics, California Academy of Science",
            "Prerequisites:  Algebra II, or Equivalent; Familiarity & Interest in programming \
             recommended",
            "Cluster 6 - Mathematics*",
            "*This cluster is first choice only. This cluster is designed to introduce students \
             with a strong interest in mathematics to several advanced topics. These topics would \
             ordinarily be studied at the advanced undergraduate level, but all lend themselves \
             to an introductory course at the high school level. No prior experience in any of \
             these topics is expected, but enthusiasm for and interest in mathematics is \
             essential. Students in this cluster will gain insight into what to expect from \
             studying mathematics, or applied mathematics, in university. There will be an \
             emphasis on doing mathematics and getting hands-on experience! Typical Field Trips: \
             Exploratorium, California Academy of Science",
            ...
            "In this cluster, we will introduce students to the microbes that live on and in \
             ...
             and testing of a plant-microbe-inspired game. Typical Field Trips: UC Davis \
             Arboretum, Armstrong Ranch (Plant Pathology Field Station), Plant Pathology \
             Diagnostic Lab, a commercial processing tomato field, a local agrobiotech company",
            "Prerequisites: None.  Prior experience in biology and lab courses are highly \
             recommended.",
            ...
            "This cluster is designed for aspiring students seeking to expand their knowledge and \
             ...
             disciplines. Typical Field Trips: UC Davis Center for Nano-Micro Manufacturing, \
             Lawrence Berkeley National Lab (LBNL)",
            "Prerequisites: Programming Experience (strongly recommended), Physics class that \
             includes Electricity & Magnetism, Algebra II, or Equivalent",
            ...
            "This cluster will introduce students to a wide variety of mathematical models used \
             ...
             working at the interface of mathematics and biology. Typical Field Trips: \
             Exploratorium, California Academy of Science",
            "Prerequisites: Algebra II, Integrated Math III, or equivalent (required); \
             Precalculus or equivalent (recommended)",
            ...
            "A sustainable transportation system meets society’s needs for movement while \
             ...
             engineering, environmental engineering, economics, and statistics. Typical Field \
             Trips: Siemens Mobility, Davis Bicycle Network, Unitrans Bus Yard, and mobility \
             providers like Lime & Cruise",
            ...
            "Data is everywhere—from social media trends that shape our daily interactions to \
             ...
             make informed decisions, and drive innovation. Typical field trips: Google (Mountain \
             View), California Academy of Sciences, Exploratorium",
            "Prerequisite: Algebra II or Integrated Math II, Programming Experience (recommended \
             but not required)",
            ...
            "Machine learning (ML), a subset of Artificial Intelligence, is considered a \
             ...
             data-driven decisions based on historical observations and data. Typical Field \
             Trips: Exploratorium, California Academy of Science",
             "Prerequisites: Algebra II / Integrated Math II; Programming Experience Required, Python Preferred (see below)",
        ])),
        ..cosmos_default.clone()
    };
    let cosmos_ucsc = SummerCamp {
        ...
        specialization: Some(make_specializations(&[
            ...
            "Prerequisite: Algebra 1 or equivalent. Preferred: Two years of high school \
             mathematics.",
            "Cluster 2 - Nanochemistry and Nanotechnology*",
            "*First choice only. At the nanometer scale (10(raised to the -9th power)m), the \
             chemical and physical properties of materials and structures show drastic deviations \
             from those of their atomic or bulk forms. Exploiting these new properties has \
             sparked research in energy, electronics, and a diversity of areas. We will introduce \
             basic principles of nanoscience and nanotechnology, and demonstrate the applications \
             of functional nanomaterials through in-house demonstrations and hands-on \
             experiments. Students will learn about the preparation and functionalization of \
             nanomaterials, their controlled assemblies, and the potential impacts on future \
             technologies. Students will also visit research facilities and laboratories as a \
             foundation for understanding, evaluating, and explaining nanotechnology. In this \
             cluster, we will uncover patterns that transcend specific technologies, enabling us \
             to evaluate whatever we create in the future.",
            ...
            "Prerequisite: Biology, Chemistry. Preferred: some basic coding capability",
            ...
            "Prerequisites: Chemistry, Pre-Calculus. Preferred: Physics, Calculus.",
            ...
            "Prerequisite: One year of Algebra II or equivalent. Preferred: Programming experience",
            ...
            " Prerequisite: Chemistry. Preferences: Physics",
            ...
            "Prerequisite: Biology. Preferences: Chemistry",
            ...
            "*First choice only. This course explores how to make machine learning algorithms as \
             efficient as the brain. Topics to be covered include logistic and linear regression, \
             neural networks, deep learning, computer vision with convolutional neural networks, \
             sequence-based models, transformers, low-power machine learning techniques, \
             low-precision and compressed models, and spiking neural networks.",
            "Prerequisites: Algebra II, Computer Science. Preferred: Pre-Calculus",
            ...
            "*First choice only. This cluster will introduce students to the basic principles of \
             safety and security and their role in developing trustworthy artificial intelligence \
             (AI) agents for autonomous decision making for self-driving vehicles and computer \
             networks",
            "Prerequisites: none. Preferred: Computer Science, Calculus",
        ])),
        ..cosmos_default.clone()
    };
    let cosmos_ucla = SummerCamp {
        ...
        specialization: Some(make_specializations(&[
            ...
            "Prerequisites: AP Biology or equivalent, Calculus BC or equivalent. Programming experience (in any language) is preferred; students who are new to programming may be asked to complete an online coding course before arrival.",
            ...
            "Prerequisites: High school-level biology",
            ...
            "Prerequisites: Physics or equivalent 9th or 10th grade-level integrated science course AP Calculus AB or equivalent.
    Experience in coding with any text-based programming language (C/C++, Python, JS, Java, Swift, Julia, …) is highly recommended.",
            ...
            "Prerequisites: Algebra II, Integrated Math III, or equivalent. It is recommended to have taken AP Computer Science. In addition to the recommendation to take AP Computer Science, candidates should have “basic comfort” in programming in any language (Python, Matlab, C, C++, Java, etc). Candidates should be able to take the average of a list of numbers, sort a list of numbers, concatenate text strings, etc.",
            ...
            "Prerequisites: Integrated Math 1.  Preferences: conceptual physics and prior laboratory experience.",
